...
def rulebasedProbablisticReasoner(pathModel, modelFileName, matchedRules, rupCases, unRupCases):
    ...
    rulesEvaluationMatrix.append(('Rupture Risk Probability', round(rulesRupRiskProbability, 2)))
...
def combined_rupture_probability(matched_rules, ann_loc):
    print("Inside combined rup.")
    rupCases = ''
    unRupCases = ''
    modelFileName = ''
    if ann_loc == "PCOM":
    ...
    evalResult = rulebasedProbablisticReasoner(pathModel, modelFileName, matched_rules, rupCases, unRupCases)
